...
""", color=discord.Color.green())
    embed.set_author(name="Time To do Some Cleaning", icon_url="https://some/image.png")
    embed.set_thumbnail(url="https://some/image.png") 
...
╰────── ⋆⋅ ✼ ⋅⋆
    """, color=discord.Color.green())
    embed.set_author(name="Minecraft Server Details", icon_url="https://imagecom/abc.gif")
    embed.set_thumbnail(url="https://imagecom/abc.png")
    embed.set_image(url="https://imagecom/abc.png")
    return embed
...
async def add_roles_to_new_member(member):
    ...
    role_ids = [1080258166908221120]#add roles id u want members to get when they join here [1080431722992238652, 987654321]. Currently >> Release + Pack -Temp Role
...
async def updateroles(ctx):
    # Get the roles IDs you want to add
    role_ids = [6486321243564576879]#add channel ids here  [7865352123456, 987654321]. Currently >> Release + Pack -Temp Role 
...
async def removeroles(ctx):
    ...
    role_ids = [9876543123456]#remove channel ids here  [12345678, 987654321]. 
